...
class CronTasksSummaryEmail(webapp2.RequestHandler):
    """Handler for cron task queue emails"""

    def get(self):
        logging.info('This is an info message')
        self.response.out.write('Hello from cron job.  You should send a email')
